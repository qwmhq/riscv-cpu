...
add wave -noupdate -group {other values} /cpu_tb/UUT/imm
add wave -noupdate -group {other values} /cpu_tb/UUT/r1
add wave -noupdate -group {other values} /cpu_tb/UUT/r2
add wave -noupdate -group {other values} /cpu_tb/UUT/alu_x
add wave -noupdate -group {other values} /cpu_tb/UUT/alu_y
add wave -noupdate -group {other values} -radix hexadecimal /cpu_tb/UUT/alu_z
...
add wave -noupdate -group {internal write signals} /cpu_tb/UUT/wr_mem
add wave -noupdate -group {internal write signals} /cpu_tb/UUT/wr_rd
add wave -noupdate -group {internal write signals} /cpu_tb/UUT/wr_pc
...
add wave -noupdate -group {control unit state machine} /cpu_tb/UUT/CU/current_state
add wave -noupdate -group {control unit state machine} /cpu_tb/UUT/CU/state_ctr
